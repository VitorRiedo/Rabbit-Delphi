...
{$EndIf}
  ...
  Public
    ...
    property MaxChannel       : Integer     read FMaxChannel    write SetMaxChannel;
...
begin
  ...
  Try
    Method.Field[ 'channel-max' ].AsShortUInt.Value := FMaxChannel;
...
procedure TAMQPConnection.SetMaxChannel(const Value: Integer);
begin
  FMaxChannel := Value;
end;
